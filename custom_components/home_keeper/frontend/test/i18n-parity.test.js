...
const COGNATE_IDENTICAL = {
  ...
  da: ['chip.orphaned', 'detail.id', 'field.doc_url', 'field.kind', 'field.model', 'field.note', 'field.sensor_entity_id', 'field.type', 'group.integration', 'group.status', 'opt.meta.link', 'opt.month.11', 'opt.month.12', 'opt.month.4', 'opt.month.8', 'opt.month.9'],
  de: ['chip.orphaned', 'detail.about', 'detail.id', 'due.in_units', 'field.doc_name', 'field.doc_url', 'field.name', 'field.sensor_entity_id', 'group.integration', 'group.status', 'opt.meta.link', 'opt.meta.text', 'opt.month.11', 'opt.month.4', 'opt.month.8', 'opt.month.9'],
  ...
  nb: ['detail.id', 'field.doc_url', 'field.kind', 'field.sensor_entity_id', 'field.type', 'group.status', 'opt.month.11', 'opt.month.4', 'opt.month.8', 'opt.month.9'],
  ...
  sv: ['chip.orphaned', 'detail.id', 'field.doc_url', 'field.sensor_entity_id', 'group.integration', 'group.status', 'opt.meta.text', 'opt.month.11', 'opt.month.12', 'opt.month.4', 'opt.month.9'],
