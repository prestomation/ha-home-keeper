...
![The Tasks tab in the Tiles layout, with each task as a card that shows the name and the status](../../images/71-panel-task-tiles.png)

![The Tasks tab in the Board layout, with one column for each group and a card for each task](../../images/71b-panel-task-board.png)
