...
A preset writes the task name and notes in the Home Assistant language. If you change
the language later, the tasks change to the new language. If you edit the name or the
notes of a recipe, Home Keeper uses your text.
