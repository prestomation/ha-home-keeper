...
consumable, the auto-completion consumes one spare and may fire
`home_keeper_part_low_stock` / `home_keeper_part_out_of_stock`, the same as any other
completion. A bound entity going
