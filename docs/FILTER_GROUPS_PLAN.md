...
describes work already implemented on this branch. It ships in 0.23.0b1.
...
> `profile filter uses groups since 0.23.0b1; move labels/areas/devices/companions and
...
`0.23.0b1` **Added** bullet for filter groups and a **Changed** bullet each for the
...
This work ships as one pull request, labelled `preview-release`, in the `0.23.0b1`
